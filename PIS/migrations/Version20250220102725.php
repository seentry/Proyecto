 ...
 */
final class Version20250220102725 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE cita (id INT AUTO_INCREMENT NOT NULL, cliente_id INT NOT NULL, trabajador_id INT DEFAULT NULL, servicio_id INT NOT NULL, fecha DATETIME NOT NULL, precio DOUBLE PRECISION NOT NULL, pagado TINYINT(1) NOT NULL, INDEX IDX_3E379A62DE734E51 (cliente_id), INDEX IDX_3E379A62EC3656E (trabajador_id), INDEX IDX_3E379A6271CAA3E7 (servicio_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE servicio (id INT AUTO_INCREMENT NOT NULL, nombre VARCHAR(255) NOT NULL, descripcion VARCHAR(255) NOT NULL, stock INT DEFAULT NULL, precio DOUBLE PRECISION NOT NULL, imagen VARCHAR(1000) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE cita ADD CONSTRAINT FK_3E379A6271CAA3E7 FOREIGN KEY (servicio_id) REFERENCES servicio (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE cita DROP FOREIGN KEY FK_3E379A6271CAA3E7');
